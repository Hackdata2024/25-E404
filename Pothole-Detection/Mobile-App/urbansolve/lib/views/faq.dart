  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(
          255, 237, 234, 229), // Match background color with HomePage
      appBar: AppBar(
        backgroundColor: Color.fromARGB(
            255, 237, 234, 229), // Match AppBar color with HomePage
        title: Row(
          children: [
            Icon(
        ...
        iconTheme: IconThemeData(
            color: Color.fromARGB(
                255, 2, 102, 112)), // Match icon color with HomePage
      ),
              ...
              title: Text(
                ...
                style: GoogleFonts.openSans(
                  textStyle: TextStyle(
                      ...
                      color: Color.fromARGB(
                          255, 2, 102, 112)), // Match text color with HomePage
                ),
              ),
              children: <Widget>[
                Padding(
                  ...
                  child: Text(
                    ...
                    style: GoogleFonts.openSans(
                      textStyle: TextStyle(
                          fontSize: 16,
                          color: Color.fromARGB(255, 2, 102,
                              112)), // Match text color with HomePage
                    ),
                  ),
                ),
              ],
